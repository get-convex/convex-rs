...
mod tests {
    ...
    use super::{
        ...
        check_valid_field_name_slow,
        check_valid_identifier,
        check_valid_identifier_slow,
        is_valid_field_name,
        is_valid_identifier,
        MIN_IDENTIFIER,
    };
    ...
    proptest! {
        ...
        fn test_field_name_fast_path(s in any::<String>()) {
            assert_eq!(is_valid_field_name(&s), check_valid_field_name_slow(&s).is_ok());
        }

        #[test]
        fn test_identifier_fast_path(s in any::<String>()) {
            assert_eq!(is_valid_identifier(&s), check_valid_identifier_slow(&s).is_ok());
        }
    }
